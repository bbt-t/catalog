...
urlpatterns = [
    ...
    path(
        "product/<int:id>/", AboutProductPageDetailView.as_view(), name="product-detail"
    ),
    path("contacts/", ContactsPageView.as_view(), name="contacts"),
    path("add/", AddProductPageView.as_view(), name="add_product"),
    path("add_version/", VersionCreateView.as_view(), name="add_product_version"),
